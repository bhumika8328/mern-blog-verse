    ...
    return (
        <div className="flex justify-center" >
            ...
            <div className="border-2 w-100 flex flex-col">
                ...
                <div className="text-md md:1/3 flex  gap-3">
                     <input type="checkbox" gap-2/> 
                    <p>remember me</p>
                    <p className="text-blue-700 text-sm:w-600px">forgot password?</p>

                </div>
                <div className="text-md md:w-1/3 px-4 py-2">
                    <p className="text-md text bg-blue-500 font-semihold px-30 py-4 text-md md:1/3">SignIn</p>
                ...
                <div className="border-[0.5px] text-md md:1/3"></div>
                <div >
                    <button className="text-white rounded-x1"></button>
                    <p className="text-md md:1/3">already have an account?<span className="text-blue-500 text-md md:1/3">create one here</span></p>
                </div>
            </div>
